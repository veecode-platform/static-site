...
export default async function Homepage({ params }: PageProps) {
  ...
  const tools = [
    {
      id: 0,
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/assets/home/toolsDetails/1.png`,
      desc: t.rich('card-1', {
    ...
    {
      id: 1,
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/assets/home/toolsDetails/2.png`,
      desc: t.rich('card-2', {
        strong: chunks => <strong>{chunks}</strong>,
      }),
    },
    {
      id: 2,
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/assets/home/toolsDetails/3.png`,
      desc: t.rich('card-3', {
        strong: chunks => <strong>{chunks}</strong>,
      }),
    },
    {
      id: 3,
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/assets/home/toolsDetails/4.png`,
      desc: t.rich('card-4', {
        strong: chunks => <strong>{chunks}</strong>,
      }),
    },
  ...
  const supportItems = [
    {
      id: 0,
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/assets/home/Support/1.svg`,
    ...
    {
      id: 1,
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/assets/home/Support/2.svg`,
    ...
    {
      id: 2,
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/assets/home/Support/3.svg`,
    ...
    {
      id: 3,
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/assets/home/Support/4.svg`,
    ...
    {
      id: 4,
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/assets/home/Support/5.svg`,
