    ...
    >
     <article>
        ...
        <div className={style.details}>
            <strong className={style.details__label}>Use our main strength to your advantage.</strong>
            ...
            <p className={style.details__text}>Contact us, we are excited to welcome you on our team!</p>
        </div>
     </article>
    </DefaultPage>
  );
