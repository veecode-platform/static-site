...
const Tools = [
  {
    ...
    title:"Devportal",
    desc:"Is a platform that centralizes your Specs and API'S s making it easy to control microservices.",
  ...
  },
  {
    ...
    title:"Safira-CLI",
    desc:" Accelerates the building of API's from an OpenAPI file..",
  ...
  },
  {
    ...
    desc:"Increasing your productivity also helping the community to grow.",
    buttonLabel:"Join Us",
